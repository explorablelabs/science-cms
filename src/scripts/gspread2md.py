...
yaml_text += "description: 'The data below is pulled from this private Google Sheet. The build script has read-only access via Google Sheets OAuth 2.0 API. Editing the Google sheets triggers a rebuild. Molecules are rendered from SMILES in the Google Sheet.'\n"
